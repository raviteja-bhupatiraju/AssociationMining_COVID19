## Mask Information
We use the official face covering orders issued by various governors’ or local authorities from [AARP State-by-State Guide to Face Mask](https://www.aarp.org/health/healthy-living/info-2020/states-mask-mandates-coronavirus.html) and [Masks4All compilation](https://masks4all.co/what-states-require-masks/). The dates are rounded to the start of the work week. 
